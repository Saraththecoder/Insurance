      ...
      <div className="container text-center">
        ...
        <div className="media-articles">
          <div className="article-card">
            <h4>BBC</h4>
            <p>"Beshak is bringing a much needed transparency to the opaque world of Indian insurance. It's an essential tool before buying any policy."</p>
          </div>
          <div className="article-card">
          ...
          <div className="article-card">
            <h4>Mint</h4>
            <p>"The community driven aspect of Beshak sets it apart. Real people sharing real claim experiences is a game changer for buyers."</p>
          </div>
        </div>
      </div>
    </section>
